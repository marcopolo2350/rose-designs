...
function planner3DPlacementHelpers(){return{wS,wE,wL,wA,getRoomFocus,defaultElevation,resolveLabel,axisYawOffset}}
function getInteriorWallNormal(r,wall){return window.Planner3DPlacement.interiorWallNormal(r,wall,planner3DPlacementHelpers())}
function getFurniturePlacement(f,r){
  return window.Planner3DPlacement.createFurniturePlacement(THREE,f,r,MODEL_REGISTRY,planner3DPlacementHelpers());
}
