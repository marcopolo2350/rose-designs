...
- `validate:furniture-style` - checks 2D furniture tint, stroke, and label-ink helpers stay in their boundary
...
- `validate:3d-textures` - checks procedural floor texture, planar UV, and contact-shadow helpers stay in the 3D texture boundary
...
- [scripts/planner2d/furniture-style.js](./scripts/planner2d/furniture-style.js) - 2D furniture tint/stroke/label style helpers
...
- [scripts/planner3d/room-shell.js](./scripts/planner3d/room-shell.js) - room shell shape, bounds, and geometry helper boundary
- [scripts/planner3d/textures.js](./scripts/planner3d/textures.js) - procedural floor texture, planar UV, and contact-shadow helper boundary
