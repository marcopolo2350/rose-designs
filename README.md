...
- `validate:3d-textures` - checks procedural floor texture and planar UV helpers stay in the 3D texture boundary
...
- [scripts/planner3d/textures.js](./scripts/planner3d/textures.js) - procedural floor texture and planar UV helper boundary
