...
- `scripts/planner3d/room-shell.js` - room shell shape, bounds, and floor geometry helper boundary
- `scripts/planner3d/textures.js` - procedural floor texture, planar UV, and contact-shadow helper boundary
